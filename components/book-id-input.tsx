                            ...
                            {popularBooks.map((book) => (
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        <span className="text-sm font-medium text-left mr-2">{book.title}</span>
                                        <span className="text-xs px-2 py-1 bg-slate-100 dark:bg-slate-700 rounded text-slate-500 dark:text-slate-400 flex-shrink-0">
                                            {book.id}
                                        </span>
                                    </div>
                                </div>
